                    ...
                    <div className='crud-form'>
                        <form onSubmit={handleSubmit}>
                            <div className='form-group row'>
                                <label className='col-sm-4 col-form-label mb-5'>Mã:</label>
                                <div className='col-sm-8'>
                                    <input type='text' name='maQG' onChange={handleInputChange} className='form-control'></input>
                                </div>
                                <label className='col-sm-4 col-form-label mb-5'>Tên ngân hàng:</label>
                                <div className='col-sm-8'>
...
export default MaNganHangSearch