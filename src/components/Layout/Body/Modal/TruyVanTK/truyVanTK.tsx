    ...
    return (
        <>
            <div onClick={handleOpen} className='mnh-search--icon'>
                <Button title={'Truy vấn TK'}></Button>
            </div>
            <Modal
                open={open}
                onClose={handleClose}
                    ...
                    <div className='crud-form'>
                        <form onSubmit={handleSubmit}>
                            <div className='form-group row'>
                                <label className='col-sm-4 col-form-label mb-5'>Số CMT/Hộ chiếu:</label>
                                <div className='col-sm-8'>
                                    <input type='text' name='maQG' onChange={handleInputChange} className='form-control'></input>
                                </div>
                                <label className='col-sm-4 col-form-label mb-5'>Mã khách hàng:</label>
                                <div className='col-sm-8'>
                                    <input type='text' name='ten' onChange={handleInputChange} className='form-control'></input>
                                </div>
                                <label className='col-sm-4 col-form-label mb-5'>Số tài khoản:</label>
                                <div className='col-sm-8'>
                                    <input type='text' name='maQG' onChange={handleInputChange} className='form-control'></input>
                                </div>
                            </div>
